...
CAR_INFO: Dict[str, Union[SubaruCarInfo, List[SubaruCarInfo]]] = {
  ...
  CAR.ASCENT_2023: SubaruCarInfo("Subaru Ascent 2023", "All", harness=Harness.subaru_d),
...
FW_QUERY_CONFIG = FwQueryConfig(
  requests=[
    ...
    Request(
      [StdQueries.TESTER_PRESENT_REQUEST, StdQueries.DEFAULT_DIAGNOSTIC_REQUEST, SUBARU_VERSION_REQUEST],
      [StdQueries.TESTER_PRESENT_RESPONSE, StdQueries.DEFAULT_DIAGNOSTIC_RESPONSE, SUBARU_VERSION_RESPONSE],
    ),
    Request(
      [StdQueries.TESTER_PRESENT_REQUEST, StdQueries.EXTENDED_DIAGNOSTIC_REQUEST, SUBARU_VERSION_REQUEST],
      [StdQueries.TESTER_PRESENT_RESPONSE, StdQueries.EXTENDED_DIAGNOSTIC_RESPONSE, SUBARU_VERSION_RESPONSE],
    ),
  ],
  extra_ecus=[
    (Ecu.engine, 0x7a2, None),         # 2023 models
    (Ecu.transmission, 0x7a3, None),   # 2023 models
  ],
)
...
GLOBAL_GEN2 = (CAR.OUTBACK, CAR.LEGACY, CAR.ASCENT_2023)
